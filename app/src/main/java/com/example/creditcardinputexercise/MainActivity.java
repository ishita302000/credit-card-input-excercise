         ...
         btn.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 ...
                 if(creditcard_No.length() == 16){
                     if(creditcard_No.charAt(0) == '4' || creditcard_No.charAt(0) == '5' || creditcard_No.charAt(0) == '6') {
                 ...
                 for (int i = creditcard_No.length() - 1; i >= 0; i--) {
                     if(check == 1) {
                         ...
                         int li = 2*(Integer.parseInt(creditcard_No.charAt(i) + ""));
                         int sumation2 = 0;
                         while(li > 0) {
                             int rem = li % 10;
                 ...
                 if(lastdate.isEmpty()){
                     date.setError("please input the date");
                     return ;
                 }
                 if(lastdate.length() != 5) {
                     date.setError("incorrect date");
                     return ;
                 }
